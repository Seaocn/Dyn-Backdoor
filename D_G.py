    ...
    for poison_epoch in range(attack_link_sum):
        ...
        for epoch in range(args.num_epochs-args.pre_num_epochs):
            ...
            if epoch == args.num_epochs//2 :
                ...
                # g_fake_data_real_one = noise_replace_graph_batch_final_noY(g_fake_noise_real[0:1, :, :, :], grad_inputs,
                #                                                        target_list)
        ...
        if len(target_list_test) != 0:
            ...
            for i in target_list_test:
                if (poison_pred_testX[i, target_list[0][1], target_list[0][2]] == 0 and yuan_link == 1) or (poison_pred_testX[
                    ...
                    # print('*****',clean_cekan_testX[i, target_list[0][1], target_list[0][2]])
                    # print('-----', clean_testX_clean[i, target_list[0][1], target_list[0][2]])
                    success_num += 1
                    poi_num += 1
